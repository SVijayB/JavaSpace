...
public class InterchangeAndAdd
{
    ...
    int n,m; static BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
    ...
    public InterchangeAndAdd mix(InterchangeAndAdd J)
    {
        ...
        // I have treated the J object's matrix as the first matrix and the currently referenced object's matrix as the second one
        ...
        for(i=0;i<m;i++)
        {
            for(j=0;j<n;j++)
            {
                ...
                if(i==0)//if the first row 
                {
                    ...
                    /*'this' keyword refers to the current object, i.e.  
                    the object which calls  mix function**/
        ...
        for(i=0;i<m;i++)
        {
            for(j=0;j<n;j++)
            {
                ...
                if(i==0)//if the first row 
                {
                    J.arr[i][j]=D[d++];//storing the second matrix's last row elements in the first row of first matrix
                    this.arr[i][j]=C[c++];//storing the first matrix's last row elements in the first row of second matrix
                }//end of if

                else if(i==(m-1))//if the last row 
                {
                    J.arr[i][j]=B[b++];//storing the second matrix's first row elements in the last row of first matrix
                    this.arr[i][j]=A[a++];//storing the first matrix's first row elements in the last row of second matrix
                }//end of else
    ...
    public static void main(String[] args)throws IOException
    {
        ...
        InterchangeAndAdd obj3 = obj2.mix(obj1); /*obj2 is the current object which is referred by
        'this' keyword above**/
        ...
        ENTER ROW OF THE ARRAYS 
        3
        ENTER COLOUMN OF THE ARRAYS 
        3
        Input the Array 
        Enter Element : 1
        Enter Element : 2
